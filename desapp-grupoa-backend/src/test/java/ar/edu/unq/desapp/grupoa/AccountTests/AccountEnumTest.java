...
public class AccountEnumTest extends TestCase{
    ...
    public void testCreateBankAccount(){
        ...
        AccountEnum accountEnum2 = AccountEnum.create("Bank account");
    ...
    public void testCreateCashAccount(){
        ...
        AccountEnum accountEnum2 = AccountEnum.create("Cash account");
    ...
    public void testCreateCurrentAccount(){
        ...
        AccountEnum accountEnum2 = AccountEnum.create("Current account");
